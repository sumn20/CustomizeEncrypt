...
#ifndef APP_ANDROID_TRTC_TRTCDEMO_MAIN_JNI_TXLITEAVBUFFER_H_
#define APP_ANDROID_TRTC_TRTCDEMO_MAIN_JNI_TXLITEAVBUFFER_H_
...
#endif  // APP_ANDROID_TRTC_TRTCDEMO_MAIN_JNI_TXLITEAVBUFFER_H_
