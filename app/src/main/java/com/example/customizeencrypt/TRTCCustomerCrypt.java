...
public class TRTCCustomerCrypt {
    ...
    public long getEncodedDataProcessingListener( ) {
        ...
        return nativeGetEncodedDataProcessingListener(new EncodedDataProcessingListenerImpl(keyMD5));
    }
    ...
    protected native long nativeGetEncodedDataProcessingListener(EncodedDataProcessingListener encodedDataProcessingListener);
}
